...
apt-get -y purge nano whoopsie apport wireless-tools ppp pppconfig pppoeconf wpasupplicant installation-report landscape-common
...
sed -i -e 's/^#GRUB_HIDDEN_TIMEOUT=0/GRUB_HIDDEN_TIMEOUT=0/' \
